...
import { LayoutDashboard, CreditCard, PieChart, Wallet, Target, Settings, LogOut } from 'lucide-react'
        ...
        <aside className={styles.sidebar}>
            ...
            <nav className={styles.nav}>
                {navItems.map((item) => {
                    ...
                    return (
                        <Link key={item.href} href={item.href} className={styles.linkContainer}>
                            <div
